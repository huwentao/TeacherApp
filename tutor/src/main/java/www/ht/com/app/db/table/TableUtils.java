...
import www.ht.com.app.db.annotation.Id;
import www.ht.com.app.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, www.ht.com.app.db.table.Id> entityIdMap = new ConcurrentHashMap<String, www.ht.com.app.db.table.Id>();

    /* package */
    static synchronized www.ht.com.app.db.table.Id getId(Class<?> entityType) {
        ...
        www.ht.com.app.db.table.Id id = new www.ht.com.app.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        www.ht.com.app.db.table.Id id = getId(entityType);
