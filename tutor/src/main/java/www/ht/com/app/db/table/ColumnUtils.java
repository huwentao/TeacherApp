...
package www.ht.com.app.db.table;

import android.text.TextUtils;

import com.orhanobut.logger.Logger;

import www.ht.com.app.db.annotation.Column;
import www.ht.com.app.db.annotation.Finder;
import www.ht.com.app.db.annotation.Foreign;
import www.ht.com.app.db.converter.ColumnConverter;
import www.ht.com.app.db.converter.ColumnConverterFactory;
import www.ht.com.app.db.sqlite.FinderLazyLoader;
import www.ht.com.app.db.sqlite.ForeignLazyLoader;
import www.ht.com.app.db.annotation.*;
...
public class ColumnUtils {
    ...
    public static String getColumnNameByField(Field field) {
        www.ht.com.app.db.annotation.Column column = field.getAnnotation(www.ht.com.app.db.annotation.Column.class);
        if (column != null && !TextUtils.isEmpty(column.column())) {
            return column.column();
        }

        www.ht.com.app.db.annotation.Id id = field.getAnnotation(www.ht.com.app.db.annotation.Id.class);
    ...
    public static String getColumnDefaultValue(Field field) {
        www.ht.com.app.db.annotation.Column column = field.getAnnotation(Column.class);
    ...
    public static Class<?> getForeignEntityType(www.ht.com.app.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(www.ht.com.app.db.table.Finder finderColumn) {
