...
//    @Bind(R.id.navigationView) NavigationView navigationView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(new TeacherReviewFragment());
        ...
        tabViewLayout.setOnTabViewChangeListener(new TabViewLayout.OnTabViewChangeListener() {
            @Override
  ...
  /*  private void setupDrawerContent(NavigationView navigationView) {
     ...
     * 切换fragment
     *
     * @param index 需要显示出来的fragment的位置{@link ParentMainActivity#fragments}
     */
